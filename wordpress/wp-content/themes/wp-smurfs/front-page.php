  ...
  <div class="pusher">
    ...
    <div class="ui inverted vertical masthead center aligned segment">
      <div class="ui center aligned container">
        <h1 class="ui inverted header"><?php the_field('first_block_title'); ?></h1>
        <h2><?php the_field('first_block_description'); ?>
          <div class="ui hidden divider"></div>
        </h2>
        <div class="ui huge orange button scrollto" data-scrollto="#pricing"><?php the_field('first_block_left_button'); ?></div>
        <div class="ui huge blue button scrollto" data-scrollto="#why-us"><?php the_field('first_block_right_button'); ?></div>
      </div>
    </div>
